...
const I18N = {
  en: {
    ...
    login_who: "Learning Ecology is the online classroom of Lê Quốc Thông, a Vietnamese teacher of English and Chinese. This page is only for enrolled students — we never ask for payment details here.",
    login_help: "Need an account or lost your password?",
    login_home: "About Learning Ecology",
  ...
  vi: {
    ...
    login_who: "Learning Ecology là lớp học trực tuyến của thầy Lê Quốc Thông — giáo viên tiếng Anh và tiếng Trung. Trang này chỉ dành cho học viên đã đăng ký; chúng tôi không bao giờ hỏi thông tin thẻ hay thanh toán ở đây.",
    login_help: "Chưa có tài khoản hoặc quên mật khẩu?",
    login_home: "Giới thiệu về Learning Ecology",
